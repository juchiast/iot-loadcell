...
#define CLK 4  // CLK of HX711 connected to pin 5 of Arduino
#define DOUT 5 // DOUT of HX711 connected to pin 6 of Arduino
...
void setup(void)
{
  ...
  // for (int x = 12; x < 16; x++)
  // { // Select the first 12 to 16 character of String
  Serial.println("ARDUINO SCALE");
  Serial.println(start_count_string);
...
void loop(void)
{
  ...
  { // Check to see which action to take
    ...
    else
    {
      ...
      { // 2 = Scale already started so restart from begining
